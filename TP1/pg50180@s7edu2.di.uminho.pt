...
struct Point{
    ...
    int centroid[N] __attribute__ ((aligned(32)));
    float minDist[N] __attribute__ ((aligned(32)));
};

struct Centroid{
    float x[N] __attribute__ ((aligned(32)));
    float y[N] __attribute__ ((aligned(32)));
    int points[N] __attribute__ ((aligned(32)));
    float sumX[N] __attribute__ ((aligned(32)));
    float sumY[N] __attribute__ ((aligned(32)));
};
